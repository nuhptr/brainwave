...
import { Generating } from "../ui/Generate"
import { PhotoChatMessage, VideoBar, VideoChatMessage } from "../design/ServicesOrnamen"
import { imgService1, imgService2, imgService3, icCheck } from "../../assets"
         ...
         <div className="relative">
            <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
               <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
                  <img src={imgService1} alt="smartest ai 1" width={800} height={730} />
               </div>
                  ...
                  <ul className="body-2">
                     {brainwaveServices.map((item, index) => (
                        <li key={index} className="flex items-start py-4 border-t border-n-6">
                           <img width={24} height={24} src={icCheck} />
               ...
               <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                  <div className="px-4 py-12 xl:px-8">
                     ...
                     <p className="body-2 mb-[2rem] text-n-3">
                        The world’s most powerful AI photo and video art generation engine. What
                        will you create?
                     </p>
